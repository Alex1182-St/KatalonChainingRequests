...
GlobalVariable.nameOfUser = value

println(' Global Variable is ' + GlobalVariable.nameOfUser)

WS.sendRequestAndVerify(findTestObject('RESTWebServices/UpdateUser', [('userName') : GlobalVariable.nameOfUser]))
